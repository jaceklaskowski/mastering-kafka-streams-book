...
`AssignedStreamsTasks` is a concrete <<kafka-streams-AssignedTasks.adoc#, AssignedTasks>> of <<kafka-streams-StreamTask.adoc#, StreamTasks>> that...FIXME
...
In the end, `maybeCommit` gives the number of running stream tasks that <<kafka-streams-StreamTask.adoc#commitNeeded, needed a commit>>.
