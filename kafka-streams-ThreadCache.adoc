...
* `GlobalStreamThread` is <<kafka-streams-GlobalStreamThread.adoc#cache, created>>
...
* `StreamThread` is <<kafka-streams-StreamThread.adoc#create, created>> (and creates a <<kafka-streams-TaskCreator.adoc#cache, TaskCreator>>)
