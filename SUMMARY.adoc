...
. link:kafka-streams-StateStore.adoc[StateStore Contract -- State Storage Engines]
...
. link:kafka-streams-AbstractProcessorContext.adoc[AbstractProcessorContext]
...
. link:kafka-streams-StateManager.adoc[StateManager Contract -- State Storage Engine Managers]
