...
`StateManager` is the <<contract, contract>> of <<implementations, state store managers>> that manage <<kafka-streams-StateStore.adoc#, state stores>> and are <<kafka-streams-internals-Checkpointable.adoc#, checkpointable>>.
...
| <<kafka-streams-internals-GlobalStateManager.adoc#, GlobalStateManager>>
| [[GlobalStateManager]]
|===
