...
`GlobalStateManagerImpl` is a concrete <<kafka-streams-internals-GlobalStateManager.adoc#, GlobalStateManager>> (and a <<kafka-streams-internals-AbstractStateManager.adoc#, AbstractStateManager>>) that...FIXME
...
NOTE: `initialize` is part of link:kafka-streams-internals-GlobalStateManager.adoc#initialize[GlobalStateManager Contract] to...FIXME.
...
NOTE: `checkpoint` is part of link:kafka-streams-internals-Checkpointable.adoc#checkpoint[Checkpointable Contract] to...FIXME.
