== [[Topology]] Topology -- Directed Acyclic Graph of Stream Processors

`Topology` is an *acyclic graph of stream processing nodes* (_DAG of stream processors_) that represents the stream processing logic of a Kafka Streams application.
