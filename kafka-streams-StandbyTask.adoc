...
| processorContext
| [[processorContext]] <<kafka-streams-InternalProcessorContext.adoc#, InternalProcessorContext>>
...
* [[consumer]] Kafka https://kafka.apache.org/20/javadoc/org/apache/kafka/clients/consumer/KafkaConsumer.html[Consumer] (of keys and values as array of bytes, i.e. `byte[]`)
