...
<<kafka-streams-ProcessorStateManager.adoc#creating-instance, Initialized>> when `AbstractTask` is <<creating-instance, created>>
...
NOTE: `getStore` is part of the <<kafka-streams-Task.adoc#getStore, Task Contract>> to...FIXME.
