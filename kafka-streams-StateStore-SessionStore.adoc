...
* `KStreamSessionWindowAggregateProcessor` is requested to link:kafka-streams-KStreamSessionWindowAggregateProcessor.adoc#process[process a key-value record]
