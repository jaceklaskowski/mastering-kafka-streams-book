...
NOTE: `punctuate` is part of link:kafka-streams-internals-ProcessorNodePunctuator.adoc#punctuate[ProcessorNodePunctuator Contract] to execute a scheduled periodic action.
