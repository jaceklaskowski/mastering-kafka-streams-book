...
NOTE: link:kafka-streams-StreamThread.adoc[StreamThread] uses a `StoreChangelogReader` to create a link:kafka-streams-TaskCreator.adoc#storeChangelogReader[TaskCreator], a link:kafka-streams-StandbyTaskCreator.adoc#storeChangelogReader[StandbyTaskCreator] and a link:kafka-streams-internals-TaskManager.adoc#changelogReader[TaskManager].
