...
* `MeteredSessionStore` is requested to <<kafka-streams-StateStore-MeteredSessionStore.adoc#remove, remove a session>> and <<kafka-streams-StateStore-MeteredSessionStore.adoc#put, store an aggregated value for a session>>
