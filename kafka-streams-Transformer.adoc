...
Used exclusively when `KStreamTransformProcessor` is requested to <<kafka-streams-internals-KStreamTransformProcessor.adoc#close, close>>
...
Used exclusively when `KStreamTransformProcessor` is requested to <<kafka-streams-internals-KStreamTransformProcessor.adoc#init, initialize itself>>
...
Used exclusively when `KStreamTransformProcessor` is requested to <<kafka-streams-internals-KStreamTransformProcessor.adoc#process, process a record>>
|===

`Transformer` is used to create a <<kafka-streams-internals-KStreamTransformProcessor.adoc#, KStreamTransformProcessor>>.
