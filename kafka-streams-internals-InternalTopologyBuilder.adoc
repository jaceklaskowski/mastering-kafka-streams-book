...
| stateFactories
a| [[stateFactories]][[getStateStores]] <<kafka-streams-internals-StateStoreFactory.adoc#, StateStoreFactories>> by name (of the <<kafka-streams-StoreBuilder.adoc#, StoreBuilder>>) (`Map<String, StateStoreFactory>`)
