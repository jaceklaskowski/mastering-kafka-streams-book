...
* <<kafka-streams-AbstractTask.adoc#flushState, AbstractTask>> and <<kafka-streams-internals-GlobalStateUpdateTask.adoc#flushState, GlobalStateUpdateTask>> are requested to flush state stores
