...
`RocksDBSegmentedBytesStore` is a concrete <<kafka-streams-StateStore.adoc#, StateStore>> (as a <<kafka-streams-StateStore-AbstractRocksDBSegmentedBytesStore.adoc#, AbstractRocksDBSegmentedBytesStore>> of `KeyValueSegments`) that...FIXME
